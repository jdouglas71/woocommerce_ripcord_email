...
/**
 * A Ripcord Welcome WooCommerce Email class
 *
 * @since 0.1
 * @extends \WC_Email
 */
class WC_Ripcord_Welcome_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->id = 'wc_ripcord_welcome_order';

		// this is the title in WooCommerce Email settings
		$this->title = 'Ripcord Welcome';

		// this is the description in WooCommerce email settings
		$this->description = 'Ripcord Welcome Message';

		// these are the default heading and subject lines that can be overridden using the settings
		$this->heading = 'Welcome to Ripcord';
...
} // end WC_Ripcord_Welcome_Email class
